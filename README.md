...
1. install it via `uv pip install opencv_python_headless-4.10.0.84-cp312-cp312-linux_x86_64.whl`, chose yours from https://github.com/orapilot/pyfiles/releases
